...
// แม้ว่าจะประกาศให้มีพารามิเตอร์เพียงตัวเดียว แต่ก็สามารถส่งค่าอากิวเมนต์หลาย ๆ ตัวให้กับฟังก์ชันได้
...
function createGrade(firstName, lastName, { gender, age, subject, gpa } ) {
	// สามารถใช้ตัวแปร gender, age, subject, gpa ในฟังก์ชันได้ตามปกติ
...
## การประกาศฟังก์ชันภายในบล็อก

```js
"use strict";
if(true) {
	sayHello();			         // จะมองเห็นฟังก์ชัน sayHello() 
	function sayHello() {		         // ประกาศฟังก์ชัน
	          console.log("to do something");  // "to do something"
	          // จะมองเห็นฟังก์ชัน sayBye()		
 	          console.log(sayBye.name);          // "sayBye"
	          function  sayBye() {	         // ประกาศฟังก์ชัน
	         	    // ซอร์สโค้ด
                      } // สิ้นสุดฟังก์ชัน sayBye
	} // สิ้นสุดฟังก์ชัน sayHello
...
if(true) {
          ...
          let sayHello = function() {	             // ประกาศฟังก์ชัน
	    // ซอร์สโค้ดฟังก์ชัน
          }
          console.log(typeof sayHello);         // "function"
}
...
* ตตัวอย่างที่ 1 จะเป็นการประกาศฟังก์ชันธรรมดา
