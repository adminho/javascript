...
* ตัวอย่างที่ 1
หมายเหตุ ตัวอย่างนี้ต้องรันไฟล์ ajax.mjs ที่เครื่องตัวเองขึ้นมาด้วย
แต่ถ้าไม่สะดวก็ให้เปลี่ยน url จาก http://127.0.01:8001/messagepromise
เป็น https://patanasongsivilai.com/example/ajax.php
...
หมายเหตุ ตัวอย่าง html ถัดไป ต้องรันไฟล์ ajax.mjs ที่เครื่องตัวเองขึ้นมาด้วย
แต่ถ้าไม่สะดวก็ให้เปลี่ยน url จาก http://127.0.01:8001/message?msg=test promise
เป็น https://patanasongsivilai.com/example/ajax.php?msg=test promise
