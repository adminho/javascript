...
ในตัวอย่างดังกล่าว คลาส Division จะสืบทอดสมาชิก (พร็อพเพอร์ตี้) จากคลาส Calculation ได้แก่ a,b และ multiply และเราสามารถเข้าถึงพร็อพเพอร์ตี้เหล่านี้ได้
...
มันจะหมายความว่าให้ส่ง 20 กับ 10 ไปให้คอนสตรัคเตอร์ของ Calculation กำหนดค่าให้กับ this.a  และ this.b ตามลำดับ
