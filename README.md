...
ตัวอย่างนี้จะแสดงการเขียน JavaScript บนเว็บเบราเซอร์ โดยใช้ Traceur ทำตัวเป็น transpiler (คอมไพลเลอร์) เพื่อแปลงซอร์สโค้ดให้อยู่ในรูปเวอร์ชั่น ES5 จากนั้นเว็บเบราเซอร์ถึงจะทำงานได้  (อย่าเพิ่งซีเรียสกับซอร์โค้ดตัวอย่างที่ยกมาให้ดูครับ)
