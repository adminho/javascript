...
จะสรุปเนื้อหาเกี่ยวกับ JavaScript ยุคใหม่ (ES6) พร้อมทั้งซอร์สโค้ดตัวอย่าง และเนื้อหาที่เพิ่มเข้ามา (ไม่อยู่ในหนังสือ) เช่น ES7 และอื่นๆ อีกมากมาย  ซึ่งตอนนี้ผมยังเขียนสรุปยังไม่เสร็จดี (เสร็จไปแค่ 1 %) ว่างๆ ก็จะมาอัพเดตใหม่เรื่อยๆ  

### ถ้าสนใจสามารถสั่งซื้อเล่มนี้ได้ที่
