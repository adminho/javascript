...
* เนื้อหาทั้งหมดต่อไปนี้จะเหมือนเป็นภาคต่อจากหนังสือในรูปข้างต้นครับ
* จะเป็นการพาทัวร์ภาษาจาวาสคริปต์ (JavaScript) ยุคสมัยใหม่ตามมาตรฐาน ES6 ซึ่งเนื้อหาจะต่างจากหนังสือข้างต้น (แต่ไม่ละเอียดเท่า)
* จะพูดถึงภาษาจาวาสคริปต์ (JavaScript) ยุคสมัยใหม่ตามมาตรฐาน ES7, ES8
* รวมทั้งเพิ่มเนื้อหาที่ไม่อยู่ในหนังสืออีกมากมาย 
* ซึ่งตอนนี้ผมยังเขียนสรุปไม่เสร็จดี ว่างๆ ก็จะมาอัพเดตใหม่เรื่อยๆ อัพเดตใหม่เรื่อยๆ
...
### จาวาสคริปต์ในปัจจุบัน
ต้องยอมรับว่าปัจจุบันนี้ จาวาสคริปต์มันก้าวหน้าไปไกลมาก ต่างจากเมื่อก่อนลิบลับ จากหัวข้อก่อนหน้านี้ คงจะเห็นว่า

เราสามารถพัฒนาเว็บแอพพลิเคชั่นด้วยจาวาสคริปต์ล้วน ๆ (“Full Stack JavaScript”) หมายความว่า งานพัฒนาซอฟต์แวร์ตั้งแต่ฝั่งหน้าเว็บเบราเซอร์ ไปจนถึงหลังบ้าน (ฝั่งเซิร์ฟเวอร์) หรือแม้กระทั่งติดต่อฐานข้อมูล หรือติดต่อระบบอื่น ๆ ก็สามารถใช้จาวาสคริปต์อย่างเดียว โดยปราศจากภาษาฝั่งเซิร์ฟเวอร์ เช่น JSP, ASP และ PHP เป็นต้น 

ไม่เพียงเท่านั้นมันยัง....

* ใช้จาวาสคริปต์พัฒนาแอปพลิเคชั่นบนเดสก์ท็อป (Desktop applications) ด้วยการใช้ CommonJS 
* ใช้จาวาสคริปต์ร่วมกับฐานข้อมูลแบบ NoSQL (ปราศจากภาษา SQL) เช่น Apache CouchDB และ MongoDB เป็นต้น
* ใช้จาวาสคริปต์ร่วมกับ HTML และ CSS เพื่อสร้างแอปพลิเคชั่นบนมือถือ (Mobile applications) ด้วยการใช้ PhoneGap หรือ Cordova หรือ Meteor เป็นต้น
* ใช้จาวาสคริปต์ด้านฮาร์ดแวร์ ไม่ว่าจะใช้งานด้านหุ่นยนต์คอมพิวเตอร์ (robotics) หรืองานด้าน IoT (the Internet of Things) เป็นต้น
* และอื่นๆ
