...
แสดงตัวอย่างซอร์สโค้ดของจาวาสคริปต์ที่เขียนขึ้นตามมาตรฐานเก่า ES5 โดยมันจะต้องแทรกอยู่ภายใต้แท็ก “<script> ...</script>” ของไฟล์ HTML สมมติว่าเป็นไฟล์ index.html
