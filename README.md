...
เนื้อหาทั้งหมดต่อไปนี้ จะสรุปเกี่ยวกับ JavaScript ยุคใหม่ (ES6) จากหนังสือตามรูปข้างต้นครับ รวมทั้งยังเพิ่มเนื้อหาอื่นที่ไม่อยู่ในหนังสือ เช่น ES7 และอื่นๆ อีกมากมาย ซึ่งตอนนี้ผมยังเขียนสรุปยังไม่เสร็จดี (เสร็จไปแค่ 1 %) ว่างๆ ก็จะมาอัพเดตใหม่เรื่อยๆรื่อยๆ  
