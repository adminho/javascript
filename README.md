...
```
*** หมายเหตนี้วิธี import ไฟล์ด้วยวิธีนี้ของ Traceur ถ้าไปเปิดดูบน Google Chrome อาจไม่ทำงาน แต่ไม่ต้องซีเรียส เรามีทางแก้ไข แนะนำให้ไปอ่านหัวข้อ Cross-origin resource sharing (CORS) 
...
### ทริคเล็กน้อยถ้าจะโหลดไฟล์ Traceur กับ Babel มาเก็บไว้ที่เครื่อง

#### Traceur แบบออฟไลน์

จากตัวอย่างก่อนๆ เวลาเขียน ES6 กับ ES7 บนว็บบราวเซอร์ ผมต้องอ้างถึงไฟล์ traceur.js กับ BrowserSystem.js แบบออนไลน์ แต่ถ้าจะโหลดไฟล์นี้ (ทั้งหมดที่เกี่ยวข้อง) มาเก็บไว้ที่เครื่องแบบออฟไลน์ ก็ให้ใช้คำสั่ง npm ข้างล่าง (วิธีติดตั้งและใช้งาน npm ก็ตามหนังสือข้างบนที่แจก)
